...
class MyLinkedList
{
  ...
  public:
    ...
    { 
      ...
      public:
        ...
        const_iterator& operator-- () //required
        {
            // code begins
        ...
        const_iterator operator-- (int) //required
        {
            // code begins
            const_iterator old = *this;
            --(*this);
    ...
    class iterator : public const_iterator
    {
      ...
      public:
        ...
        iterator operator-- (int) //required
        {
            // code begins
            iterator old = *this;
            --(*this);
  ...
  public:
    ...
    iterator erase(iterator itr)
    {
        ...
        p->prev->next = p->next;
        p->next->prev = p->prev;
        //This line is in the textbook but leads to memory issues when testing (line 394)
        //delete p; 
    ...
    void reverseList() //required
    {
        ...
        {
            temp-> push_front(currentNode->data);
    ...
    MyLinkedList<DataType>& appendList(MyLinkedList<DataType>&& rlist) //required
    {
        // code begins


        iterator itr = rlist.begin();
        for(itr; itr != rlist.end();itr++)
        {
    ...
    bool swapAdjElements(iterator& itr) //required
    {
        // code begins
